            ...
            <div className="p-4 rounded-lg bg-neutral-900 text-neutral-200 dark:bg-neutral-950 border border-neutral-800 flex items-start gap-3">
              ...
              <div className="text-xs space-y-1">
                <p className="font-bold text-white uppercase tracking-wider font-mono">
                  Evidence-Based Risk Diagnostic Result:
                </p>
                <p className="text-neutral-300">
                  "Your startup concept displays operational and structural patterns associated with historical venture failures. This is an evidence-based risk intelligence assessment to guide your defensive strategy."
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="vault-card p-6 flex flex-col items-center justify-center text-center">
                <RiskScoreGauge 
                  ...
                  label="Composite Failure Pattern Index" 
                />
